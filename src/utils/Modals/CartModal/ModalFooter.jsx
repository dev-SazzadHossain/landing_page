...
const ModalFooter = ({
    ...
    useEffect(() => {
        ...
        setTotalDisCount(
            Math.floor(JSON.parse(localStorage.getItem("disCount")))
        );
        customerDiscount
            ? setTotalDisCount(
                  Math.floor((customerDiscount / 100) * totalPrice)
              )
            : setTotalDisCount(
                  Math.floor(JSON.parse(localStorage.getItem("disCount")))
              );
            ...
            <div>
                <div className="input-group mb-3">
                    ...
                    >
                        <li>
                            <a
                                ...
                                href="#"
                                onClick={() =>
                                    setDiscountAndCloseDropdown("Percentage")
                                }
                            >
                                Percentage
                            </a>
                    ...
                    <input
                        ...
                        type="text"
                        value={
                            customerDiscount > 0 ? customerDiscount : disCount
                        }
